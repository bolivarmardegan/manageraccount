...
public class CarregarMenuConfiguracoes implements InterfaceMenu {
	
	private InterfaceMenu proximoGrupoMenu;

	@Override
	public void carregarMenu(final Usuario usuario, final SubMenusDAO subMenuDAO, List<Menu> menusPlano,List<MenuModel> menusCarregados) {
